...
test('Test that straight hand parser recognizes when a hand is NOT a straight.', function () {
  expect((0, _straight["default"])((0, _handParser["default"])('2H 3D 8S TC AS'))).toBe(false);
});
test('Test identification of straight.', function () {
  expect((0, _straight["default"])((0, _handParser["default"])('2H 3H 4H 5H 6H'))).toBe(true);
  expect((0, _straight["default"])((0, _handParser["default"])('2H 3C 4H 5S 6D'))).toBe(true);
});